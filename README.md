...
The emulator was used to run the following tests and successfully passed all of them:
...
To build the project and run the generated executable, use:

```bash
make all
```

This will generate the executable file at `build/chip8`. To see the list of emulator settings, run:
